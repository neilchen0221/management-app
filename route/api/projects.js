	...
	Project.findById(req.params.id)
		.then(project => {
			...
			statistics.totalExpense =
				statistics.totalLabourExpense + statistics.totalMaterialExpense + statistics.totalPetrolExpense + statistics.totalOtherExpense;
...
// @route  Put api/projects/:projectId/worknotes/:workNoteId
